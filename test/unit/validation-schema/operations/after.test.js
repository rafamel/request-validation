const after = require('../../../../src/validation-schema/operations/after');

// Mocks
jest.mock('../../../../src/validation-schema/operations/parse-input');
const {
  stringPaths
} = require('../../../../src/validation-schema/operations/parse-input');
stringPaths
...
test(`Throws on stringPaths throw, passes args to stringPaths`, () => {
...
test(`Each applies proper Joi method`, () => {
  const mocks = {
...
test(`Inner function throws when key doesn't exist`, () => {
  const dummies = {
    requiredKeys: () => {},
    optionalKeys: () => {},
    forbiddenKeys: () => {}
