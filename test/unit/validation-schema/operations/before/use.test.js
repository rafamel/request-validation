const {
  use
} = require('../../../../../src/validation-schema/operations/before');
...
test(`Doesn't mutate previous schema, calls pathTree`, () => {
...
test(`Works with empty & existing current`, () => {
  const schema = exSchema();
...
test(`Fails on non existent key`, () => {
  const schema = exSchema();
