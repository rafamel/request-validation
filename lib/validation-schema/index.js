...
const validArgs = require('./valid-args');
...
class ValidationSchema {
    ...
    clear() {
        const cleared = new ValidationSchema();
        cleared[symbol.schema] = this[symbol.schema];
        return cleared;
    }
    ...
    add(addSchema) {
        validArgs.schema(addSchema);
        return addOperation.before.call(this, 'add', addSchema);
    }
    concat(concatSchema) {
        validArgs.schema(concatSchema);
